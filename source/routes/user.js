...
router.post('/create', (0, express_validator_1.body)("username")
    .notEmpty()
    .isString()
    .isLength({ max: 255 })
    .custom(function (value) { return __awaiter(void 0, void 0, void 0, function () {
    var userExist, error_1;
    ...
    .notEmpty()
    .isString(), middleware_1.handleInputErrors, UserController.createUser);
router.post("/signin", (0, express_validator_1.body)("username")
    .notEmpty()
    .isString(), (0, express_validator_1.body)("password")
    .notEmpty()
    .isString(), middleware_1.handleInputErrors, UserController.signIn);
